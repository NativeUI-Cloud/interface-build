...
export default function TelegramTriggerNode({ 
  ...
  const handleDoubleClick = () => {
    if (onNodeDoubleClick) {
        console.log(`Telegram Trigger Node ${id} double-clicked. No modal configured yet.`);
    }
  };
  ...
  return (
    <div
      className="relative bg-blue-600 text-white rounded-lg shadow-md border border-blue-500 w-56 min-h-[80px] p-3 flex flex-col select-none"
      style={{
        position: 'absolute',
    ...
    >
      ...
      <div className="flex items-center space-x-2 mb-auto"> {/* mb-auto pushes content to top */}
        <Send className="h-6 w-6 text-blue-200 flex-shrink-0" />
